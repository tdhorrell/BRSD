...
class BRSD_sm(object):
    ...
    def state_to_s1(self, even_data):        
        return self.bump_flag == 1
    
    def state_to_s2(self, even_data):       
        return self.user_flag == 0
    
    def state_to_i1(self, even_data):       
        return self.y_cord <= 0 or self.joystick == 0
    
    def s1_to_b1(self, even_data):
        return self.state_time > 5
...
transitions = [
    ...
    # stop 1 transitions  
    {'trigger': 'check', 'source': 's1', 'dest': 'b1', 'conditions': 's1_to_b1'},
    ...
    {'trigger': 'check', 'source': 'b1', 'dest': 'l1', 'conditions': 'i1_to_l1'},
    {'trigger': 'check', 'source': 'b1', 'dest': 'r1', 'conditions': 'i1_to_r1'},
...
class BrsdFsmNode(Node):
    ...
    def update_bump(self, msg):
        self.brsd.model.bump_flag = msg.data
